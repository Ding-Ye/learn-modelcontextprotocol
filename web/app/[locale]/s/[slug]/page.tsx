...
function guessUpstreamFile(slug: string): string | null {
  // Map docs/<locale>/<slug>.md → upstream-readings/<file>.{ts,mdx,md}
  // Slices of the upstream MCP spec live under upstream-readings/.
  const map: Record<string, string> = {
    "s01-min-loop": "s01-min-loop.ts",
    "s02-initialize": "s02-initialize.ts",
    "s03-tools": "s03-tools.ts",
    "s04-resources": "s04-resources.ts",
    "s05-prompts": "s05-prompts.ts",
    "s06-sampling": "s06-sampling.ts",
    "s07-roots-elicitation": "s07-roots-elicitation.ts",
    "s08-streamable-http": "s08-streamable-http.mdx",
  };
