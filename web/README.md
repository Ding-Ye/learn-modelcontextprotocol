...
Next.js 16 doc viewer for learn-modelcontextprotocol. Static site that reads `../docs/{zh,en}/*.md` at build time and renders the curriculum side-by-side in two languages.
